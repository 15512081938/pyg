<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"D:\phpStudy\PHPTutorial\WWW\pyg\public/../application/home\view\order\paysuccess.html";i:1570002457;s:72:"D:\phpStudy\PHPTutorial\WWW\pyg\application\home\view\layout\layout.html";i:1570629132;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="cart py-container">
    ...
    <div class="paysuccess">
        <div class="success">
            ...
            <div class="paydetail">
                <p>支付方式：<?php echo (isset($pay_type) && ($pay_type !== '')?$pay_type:'支付宝'); ?></p>
                <p>支付金额：￥<?php echo $total_amount; ?>元</p>
                <p class="button"><a href="javascript:void(0);" class="sui-btn btn-xlarge btn-danger">查看订单</a>&nbsp;&nbsp;&nbsp;&nbsp;<a
                        href="<?php echo url('home/index/index'); ?>" class="sui-btn btn-xlarge ">继续购物</a></p>
            </div>
        </div>
