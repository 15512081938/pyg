<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:87:"D:\phpStudy\PHPTutorial\WWW\pyg\public/../application/admin\view\goods\product-add.html";i:1563117800;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
			...
			<div class="tabCon">
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="goods_name" id="" placeholder="控制在50个字符以内" value="" class="input-text">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>商品简介：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<textarea class="textarea" name="goods_remark" placeholder="控制在200个字符以内"></textarea>
					</div>
				</div>
				<div class="row cl">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="goods_price" id="website-Keywords" placeholder="" value="" class="input-text">
					</div>
				</div>
				<div class="row cl">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="cost_price" id="" placeholder="" value="" class="input-text">
					</div>
				</div>
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<div class="uploader-thum-container">
							...
							<input type="hidden" id="goods_logo" name="goods_logo" value="">
						</div>
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<div class="radio-box">
							<input name="is_free_shipping" type="radio" id="nav-1" value="1" checked>
							<label for="nav-1">是</label>
						</div>
						<div class="radio-box">
							<input name="is_free_shipping" type="radio" id="nav-2" value="0">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="goods_number" id="" placeholder="" value="100" class="input-text">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span class="c-red"></span>关键词：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="keywords" id="" placeholder="多个关键词，用空格隔开" value="" class="input-text">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span class="c-red"></span>详情描述：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<textarea name="goods_desc" id="editor" placeholder="" class=""></textarea>
					</div>
				</div>
				<div class="row cl">
