<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"D:\phpStudy\PHPTutorial\WWW\pyg\public/../application/home\view\cart\addcart.html";i:1569498782;s:72:"D:\phpStudy\PHPTutorial\WWW\pyg\application\home\view\layout\layout.html";i:1570629132;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <div class="goods">
            <div class="left-good">
                ...
                <div class="right-info">
                    ...
                    <p class="attr"><?php echo $goods['value_names']; ?> 数量：<?php echo $goods['goods_number']; ?></p>
                </div>
            </div>
            ...
            <div id="myCarousel" data-ride="carousel" data-interval="false" class="sui-carousel slide">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="active item">
                        <ul class="yui3-g">
                            <?php if(is_array($tuijian) || $tuijian instanceof \think\Collection || $tuijian instanceof \think\Paginator): $i = 0;$__LIST__ = is_array($tuijian) ? array_slice($tuijian,0,8, true) : $tuijian->slice(0,8, true); if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                            <li class="yui3-u-1-4">
                                <div class="banner-item">
                                    <div class="p-img"><a href="<?php echo url('home/goods/detail', ['id'=>$v['id']]); ?>"><img src="/static/home/img/_/gocart01.jpg"></a></div>
                                    <div class="p-name"><a href="<?php echo url('home/goods/detail', ['id'=>$v['id']]); ?>"><?php echo $v['goods_name']; ?></a></div>
                                    <div class="p-price">￥<?php echo $v['goods_price']; ?></div>
                                    <div class="p-btn"><a href="javascript:;" target="_blank" class="sui-btn btn-bordered  ">加入购物车</a></div>
                                </div>
                            </li>
                    ...
                    <div class="item">
                        <ul class="yui3-g">
                        <?php if(is_array($tuijian) || $tuijian instanceof \think\Collection || $tuijian instanceof \think\Paginator): $i = 0;$__LIST__ = is_array($tuijian) ? array_slice($tuijian,9,8, true) : $tuijian->slice(9,8, true); if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                            <li class="yui3-u-1-4">
                                <div class="banner-item">
                                    <div class="p-img"><a href="<?php echo url('home/goods/detail', ['id'=>$v['id']]); ?>"><img src="/static/home/img/_/gocart01.jpg"></a></div>
                                    <div class="p-name"><a href="<?php echo url('home/goods/detail', ['id'=>$v['id']]); ?>"><?php echo $v['goods_name']; ?></a></div>
                    ...
                    <div class="item">
                        <ul class="yui3-g">
                            <?php if(is_array($tuijian) || $tuijian instanceof \think\Collection || $tuijian instanceof \think\Paginator): $i = 0;$__LIST__ = is_array($tuijian) ? array_slice($tuijian,17,8, true) : $tuijian->slice(17,8, true); if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                            <li class="yui3-u-1-4">
                                <div class="banner-item">
                                    <div class="p-img"><a href="<?php echo url('home/goods/detail', ['id'=>$v['id']]); ?>"><img src="/static/home/img/_/gocart01.jpg"></a></div>
                                    <div class="p-name"><a href="<?php echo url('home/goods/detail', ['id'=>$v['id']]); ?>"><?php echo $v['goods_name']; ?></a></div>
                        ...
                        <ul class="yui3-g">
                            <li class="yui3-u-1-4">
                                <div class="banner-item">
                                    ...
                                    <div class="p-btn"><a href="success-cart.html" target="_blank"
                                                          class="sui-btn btn-bordered  ">加入购物车</a></div>
                                </div>
                            </li>
                            <li class="yui3-u-1-4">
                                <div class="banner-item">
