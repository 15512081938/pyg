<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"D:\phpStudy\PHPTutorial\WWW\pyg\public/../application/home\view\index\index.html";i:1570673612;s:72:"D:\phpStudy\PHPTutorial\WWW\pyg\application\home\view\layout\layout.html";i:1570629132;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <div class="bd">
            <ul class="clearfix yui3-g" id="">
                ...
                <li class="yui3-u-1-3" data-id="<?php echo $live['id']; ?>" style="cursor:pointer;overflow: hidden;height: 250px;">
                    <div class="left" style="float:left;width:250px;height: 250px;position: relative;">
                        <img width="100%" src="<?php echo $live['image']; ?>">
                        <div style="position: absolute;left:0;bottom:0;width:250px;font-size: 18px;color: deepskyblue;display: flex;justify-content: center;align-content: center;">
                            <?php echo $live['title']; ?>
                        </div>
                    </div>
