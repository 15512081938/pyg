<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"D:\phpStudy\PHPTutorial\WWW\pyg\public/../application/admin\view\role\admin-role-add.html";i:1559043793;}*/ ?>
﻿<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<article class="cl pd-20">
	<form action="<?php echo url('save'); ?>" method="post" class="form form-horizontal" id="form-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<?php foreach($auths as $one): ?>
				<dl class="permission-list">
					<dt>
						<label>
							<input type="checkbox" value="<?php echo $one['id']; ?>" name="auth_ids[]" >
							<?php echo $one['auth_name']; ?></label>
					</dt>
					<dd>
						...
						<dl class="cl permission-list2">
							<dt>
								<label class="">
									<input type="checkbox" value="<?php echo $two['id']; ?>" name="auth_ids[]" >
									<?php echo $two['auth_name']; ?></label>
							</dt>
							<?php foreach($two['son'] as $three): ?>
							<dd>
								<label class="">
									<input type="checkbox" value="<?php echo $three['id']; ?>" name="auth_ids[]" >
									<?php echo $three['auth_name']; ?></label>

								<label class="">
								<?php foreach($three['son'] as $four): ?>
									<input type="checkbox" value="<?php echo $four['id']; ?>" name="auth_ids[]" >
									<?php echo $four['auth_name']; endforeach; ?>
								</label>
							</dd>
							<?php endforeach; ?>
						</dl>
