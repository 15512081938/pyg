                ...
                <div class="body userSafe">
                    ...
                    <div class="tab-content ">
                        <div id="one" class="tab-pane active">
                            <form action="<?php echo url('home/user/confirm'); ?>" class="sui-form form-horizontal sui-validate" id="jsForm" method="post">
                                <input type="hidden" name="uid" value="<?php echo \think\Session::get('user_info.id'); ?>">
                                <div class="control-group">
                                    <label for="inputPassword" class="control-label">旧密码：</label>
                                    <div class="controls">
                                        <input class="fn-tinput" type="password" name="password" value=""
                                               placeholder="旧密码" required id="password" data-rule-remote="php.php">
                                    </div>
                                </div>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="fn-tinput" type="password" name="new_password" value=""
                                               placeholder="新密码" required id="new_password" data-rule-remote="php.php">
                                    </div>
                                </div>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="fn-tinput" type="password" name="confirm_password" value=""
                                               placeholder="确认新密码" required equalTo="#new_password">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <button type="submit" class="sui-btn btn-primary">确认修改</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        <div id="two" class="tab-pane">
                            ...
                            <form class="sui-form form-horizontal sui-validate" data-toggle='validate' id="bind-form">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <div><img style="width:100px;height: 30px;" src="<?php echo captcha_src(); ?>" onclick="this.src='<?php echo captcha_src(); ?>'+'?'+Math.random()"></div>
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group next-btn">
                                    <a class="sui-btn btn-primary" href="seckillsetting-address-phone.html">下一步</a>
                                </div>
                            </form>
                        </div>
                    </div>
...
<!--<script type="text/javascript" src="/static/home/js/plugins/jquery-validate/dist/jquery.validate.js"></script>-->
<!--<script>
    $(function () {
        //jquery.validate
        /*$("#jsForm").validate({
            submitHandler: function () {
                //验证通过后 的js代码写在这里
                $.ajax({
                    "url":"<?php echo url('home/user/confirm'); ?>",
                    "type":"post",
                    "data":{
