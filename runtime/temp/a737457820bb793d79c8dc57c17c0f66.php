<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"D:\phpStudy\PHPTutorial\WWW\pyg\public/../application/admin\view\login\login.html";i:1559210351;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="loginWraper">
	<div id="loginform" class="loginBox">
		<form class="form form-horizontal" action="<?php echo url('dologin'); ?>" method="post">
			<div class="row cl">
			...
			<div class="row cl">
				<div class="formControls col-xs-8 col-xs-offset-3">
					...
					<img style="width:130px;" src="<?php echo captcha_src(); ?>" onclick="this.src='<?php echo captcha_src(); ?>'+'?'+Math.random()">
				</div>
			</div>
			<div class="row cl">
				<div class="formControls col-xs-8 col-xs-offset-3">
...
<div class="footer">Copyright 品优购</div>
