<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"D:\phpStudy\PHPTutorial\WWW\pyg\public/../application/home\view\order\create.html";i:1569502783;s:72:"D:\phpStudy\PHPTutorial\WWW\pyg\application\home\view\layout\layout.html";i:1570629132;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <div class="checkout-steps">
            ...
            <div class="step-cont">
                <div class="addressInfo">
                    <ul class="addr-detail">
                        ...
                        <li class="addr-item" address_id="<?php echo $v['id']; ?>">
                            <div class="con name <?php if(($v['is_default'])): ?>selected<?php endif; ?>"><a href="javascript:;"><em><?php echo $v['consignee']; ?></em><span
                            ...
                            <div class="con address">
                                ...
                                <?php else: ?>
                                <span class="base">设为默认地址</span>
                                <?php endif; ?>
                                <span class="edittext">
										<a class="edit_address" data-toggle="modal" data-target=".edit"
                ...
                <div class="recommendAddr">
                    <ul class="addr-detail">
                        <li class="addr-item">
                            <div class="con name"><a href="javascript:;" class="selected">匹配自提点<span title="点击取消选择">&nbsp;</a>
                            </div>
                            ...
                            <div class="sendGoods">
                                ...
                                <ul class="yui3-g">
                                    ...
                                    <li class="yui3-u-7-12">
                                        <div class="desc"><?php echo $v['goods']['goods_name']; ?></div>
                                        <div class="desc"><?php echo $v['spec_goods']['value_names']; ?></div>
...
<script type="text/javascript">
    $(function () {
        ...
        $('.submit').click(function () {
            //获取选中的地址id，放到隐藏域中
            var address_id = $('.addressInfo').find('.selected').parent().attr('address_id');
