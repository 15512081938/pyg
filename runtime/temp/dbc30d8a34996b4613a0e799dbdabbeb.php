<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"D:\phpStudy\PHPTutorial\WWW\pyg\public/../application/home\view\user\address.html";i:1570620142;s:72:"D:\phpStudy\PHPTutorial\WWW\pyg\application\home\view\layout\layout.html";i:1570629132;s:77:"D:\phpStudy\PHPTutorial\WWW\pyg\application\home\view\layout\member_left.html";i:1570622826;}*/ ?>
<!DOCTYPE html>
<html>
                ...
                <div class="body userAddress">
                    ...
                    <div class="address-detail">
                        <table class="sui-table table-bordered">
                            ...
                            <tr address-id="<?php echo $v['id']; ?>" is-default="<?php echo $v['is_default']; ?>">
                                <td><?php echo $v['consignee']; ?></td>
                                <td><?php echo $v['area']; ?>&ensp;<?php echo $v['address']; ?></td>
                                ...
                                <td>
                                    ...
                                    <?php if($v['is_default'] == 1): ?><span>默认地址</span><?php else: ?><a href="#"
                                                                                      class="isDefault">设为默认</a><?php endif; ?>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                            </tbody>
...
<script>
    $(function () {
        ...
        $('.delete_id').click(function () {
            ...
            var that = this;
            $.ajax({
                "url": "<?php echo url('home/user/delete'); ?>",
                "type": "get",
                "data": {"id": id},
                "dataType": "json",
...
//                    location.href="<?php echo url('home/user/address'); ?>";
        ...
        $('tbody').on('click', '.isDefault', function () {
            ...
            if (!flag) return false;
            $.ajax({
                "url": "<?php echo url('home/user/isDefault'); ?>",
                "type": "get",
                "data": {"id": id},
                "dataType": "json",
                "success": function (res) {
...
//                    location.href="<?php echo url('home/user/address'); ?>";
        ...
        $('.edit_id').click(function () {
            ...
            $.ajax({
                "url": "<?php echo url('home/user/getEditAdd'); ?>",
                "type": "get",
                "data": {"id": id},
                "dataType": "json",
                "success": function (res) {
...
//                    console.log(arr);
        ...
        $('.btn-editdata').click(function () {
            ...
            $.ajax({
                "url": "<?php echo url('home/user/editAddress'); ?>",
                "type": "put",
                "data": obj,
                "dataType": "json",
                "success": function (res) {
...
//                    location.href="<?php echo url('home/user/address'); ?>";
        ...
        $('.btn-add').click(function () {
            ...
            $.ajax({
                "url": "<?php echo url('home/user/addAddress'); ?>",
                "type": "post",
                "data": obj,
                "dataType": "json",
                "success": function (res) {
                    ...
                    alert('地址添加成功！');
//                    location.href="<?php echo url('home/user/address'); ?>";
                    var dataHtml = `<tr address-id="<?php echo $v['id']; ?>">
                                <td><?php echo $v['consignee']; ?></td>
                                <td><?php echo $v['area']; ?>&ensp;<?php echo $v['address']; ?></td>
                                <td><?php echo $v['phone']; ?></td>
                                <td>
                                    ...
                                    <a href="#" class="delete_id">删除</a>
                                    <?php if($v['is_default'] == 1): ?>默认地址<?php else: ?><a href="#">设为默认</a><?php endif; ?>
                                </td>
                            </tr>`;
