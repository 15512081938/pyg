...
//             $("#user").append(
//                 "<li class='user-item'><div class='pic' ><img src='" + list["img"] + "' alt=''></div><div class='intro'><span>" + list["desc"] + "</span></div>"
...
//                 + "</div>"
//                 + "<a class='sui-btn btn-block btn-buy' href='user-item.html' target='_blank'>立即抢购</a>"
//                 + "</li >"
//             );
